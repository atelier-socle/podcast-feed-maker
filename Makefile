...
# Makefile — PodcastFeedMaker
#
# Targets for building, testing, linting, formatting, and installing
# the podcastfeed CLI tool.

# ---------- Variables ----------

PREFIX       ?= /usr/local/bin
BINARY_NAME   = podcastfeed
...
coverage:
	...
	TEST_BIN=$$(find .build/debug -name "PodcastFeedMakerPackageTests" -type f ! -name "*.o" -not -path "*.dSYM*" | head -1); \
...
help:
	@echo "PodcastFeedMaker — Makefile targets"
	@echo ""
