...
enum MockFeed {
    ...
    static func applePodcasts() throws -> PodcastFeed {
        PodcastFeed(
            channel: Channel(
                title: "CHANNEL TITLE",
                link: try #require(URL(string: "https://atelier-socle.com/podcasts/feed-1742426334.0261931.xml")),
                ...
                ttl: 60,
                image: RSSImage(
                    url: try #require(URL(string: "https://atelier-socle.com/podcasts/files/PodFeed-3000x3000.jpg")),
                    title: "CHANNEL TITLE",
                    link: try #require(URL(string: "https://atelier-socle.com"))
                ),
                items: try defaultItems(),
                itunesAuthor: "CHANNEL AUTHOR NAME",
                itunesBlock: false,
                itunesCategories: [.music(), .news(.techNews)],
                itunesComplete: false,
                itunesExplicit: false,
                itunesImage: try #require(URL(string: "https://atelier-socle.com/podcasts/files/PodFeed-3000x3000.jpg")),
    ...
    static func defaultItems() throws -> [Item] {
        [
            Item(
                title: "EP.0 TITLE 0",
                link: try #require(URL(string: "https://atelier-socle.com")),
                ...
                enclosure: Enclosure(
                    url: try #require(URL(string: "https://atelier-socle.com/podcasts/files/TronikShow899-Avicii.m4a")),
                    length: 27_867_798,
                    mimeType: .m4a
                ),
                ...
                itunesExplicit: true,
                itunesImage: try #require(URL(string: "https://atelier-socle.com/podcasts/files/EP0-3000x3000.jpg")),
                ...
                transcripts: [
                    Transcript(
                        url: try #require(URL(string: "https://www.buzzsprout.com/1/10167133/transcript.vtt")),
                        type: "text/vtt"
                    )
                ],
                chaptersLink: ChaptersLink(
                    url: try #require(URL(string: "https://atelier-socle.com/podcasts/files/chapter-00.json")),
            ...
            Item(
                ...
                enclosure: Enclosure(
                    url: try #require(URL(string: "https://atelier-socle.com/podcasts/files/TronikShow885-Avicii.m4a")),
                    length: 31_009_618,
                    mimeType: .m4a
                ),
                guid: GUID(value: UUID().uuidString),
                ...
                itunesExplicit: false,
                itunesImage: try #require(URL(string: "https://atelier-socle.com/podcasts/files/EP1-3000x3000.jpg")),
                itunesSeason: 2,
                ...
                chaptersLink: ChaptersLink(
                    url: try #require(URL(string: "https://atelier-socle.com/podcasts/files/chapter-01.json")),
                    type: "application/json+chapters"
                )
            )
        ]
